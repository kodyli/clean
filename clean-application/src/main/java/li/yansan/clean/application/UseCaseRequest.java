 ...
 *
 * <p>
 * This record encapsulates the necessary information to execute a business use
 * case,
 * specifically the {@link Actor} initiating the request and the business
 * payload.
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Encapsulation:</b> Holds the {@code actor} and {@code payload}
 * required for the
 * use case.
 ...
 * {@code actor} and {@code payload} are not null and satisfy any constraints
 * defined on
 * them.
 * <li><b>Transformation:</b> Provides flexible constructors to facilitate the
 * conversion
 ...
 * </ul>
 *
 * @param <UPayload> the type of the payload carrying the business data for the
 *                   use case
