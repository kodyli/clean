 ...
 *
 * <p>This record encapsulates the necessary information to execute a business use case,
 * specifically the {@link Actor} initiating the request and the business payload.
 *
 * <p><b>Responsibilities:</b>
 *
 * <ul>
 *   <li><b>Encapsulation:</b> Holds the {@code actor} and {@code payload} required for the use
 *       case.
 *   <li><b>Validation:</b> Enforces input validation upon instantiation. The {@link #validate()}
 *       method is called in the constructor to ensure that both {@code actor} and {@code payload}
 *       are not null and satisfy any constraints defined on them.
 *   <li><b>Transformation:</b> Provides flexible constructors to facilitate the conversion of
 *       external data types into the required domain objects. It supports {@link Convertible}
 *       interfaces and {@link Converter} functional interfaces to streamline this process.
 * </ul>
 *
