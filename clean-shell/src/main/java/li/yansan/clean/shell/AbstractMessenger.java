 ...
 *
 * <p>This class acts as a bridge between the core business logic and the external messaging
 * infrastructure (e.g., REST client, Queue publisher).
 *
 * <p><b>Responsibilities:</b>
 *
 * <ul>
 *   <li><b>Take Input:</b> Accepts a standardized {@link MessengerRequest} containing the payload
 *       to be sent.
 ...
 *       format requirements.
 *   <li><b>Send Input:</b> Sends the converted input to the external system via the {@link
 *       #process(Object)} method.
 *   <li><b>Map Output:</b> Converts the infrastructure output ({@code TO}) back into the usecase
 ...
 */
public abstract class AbstractMessenger<TI, TO, UPayload, UBody>
    implements Messenger<UPayload, UBody> {

  /**
   * Sends a messenger request.
   *
   * @param request the messenger request
   * @return the messenger response
   */
  @Override
  public final MessengerResponse<UBody> send(final MessengerRequest<UPayload> request) {
