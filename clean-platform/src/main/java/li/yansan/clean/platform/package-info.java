 ...
 *
 * <p>This package provides abstract base classes that implement the <b>Adapter Pattern</b>,
 * serving as the infrastructure layer in Clean Architecture. These adapters translate between
 * domain-centric application interfaces and technology-specific external implementations.
 *
 * <h2>Architecture Overview</h2>
 *
 * <p>In Clean Architecture, the application layer defines <i>what</i> needs to be done
 ...
 *
 * <p>This package provides four abstract adapter base classes:
 *
 * <h3>1. {@link ClientBase} - External API Integration</h3>
 *
 * <p>Implements {@link li.yansan.clean.application.client.Client Client} to integrate with
 ...
 *
 * <p>Implements {@link li.yansan.clean.application.repository.Repository Repository} to
 ...
 *
 * <p>Implements {@link li.yansan.clean.application.messaging.Messenger Messenger} to
 * publish events and messages to messaging systems.
 *
 * <p><b>Use Cases:</b>
 * <ul>
 ...
 *
 * <p>Bridges delivery mechanisms (REST controllers, GraphQL resolvers, CLI handlers) with
 ...
 *
 * <p>All adapters follow a consistent workflow using the Template Method pattern:
 *
 * <ol>
 ...
 *   <li><b>Validate Converted Input:</b> Ensure technical constraints are met
 *       (using Jakarta Bean Validation)
 *   <li><b>Process:</b> Execute the external operation (API call, DB query, message publish)
 ...
 * </ol>
 *
 * <p>This ensures consistency across all adapters and reduces boilerplate code.
 *
 * <h2>Generic Type Parameters</h2>
 *
 * <p>Each adapter is parameterized with four generic types:
 *
 * <ul>
 *   <li><b>TI (Technology Input):</b> The input format expected by the external system
 *       <br>Examples: {@code StripeRequest}, {@code CustomerEntity}, {@code KafkaMessage}
 *   <li><b>TO (Technology Output):</b> The output format returned by the external system
 *       <br>Examples: {@code StripeResponse}, {@code CustomerEntity}, {@code SendResult}
 *   <li><b>UPayload (Use Case Payload):</b> The domain input type from the application layer
 *       <br>Examples: {@code PaymentPayload}, {@code CustomerData}, {@code OrderEvent}
 *   <li><b>UBody (Use Case Body):</b> The domain output type for the application layer
 *       <br>Examples: {@code PaymentResult}, {@code Customer}, {@code PublishResult}
 * </ul>
 *
 * <p>This provides compile-time type safety and makes the data flow explicit.
 *
 * <h2>Key Features</h2>
 *
 * <h3>Automatic Validation</h3>
 *
 * <p>All adapters automatically validate converted inputs using Jakarta Bean Validation:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>The {@link #validate(Object)} method can be overridden for custom validation:
 *
 * <pre>{@code
 * @Override
 ...
 *
 * <p>This package follows SOLID principles:
 *
 * <ul>
 ...
 *   <li><b>Single Responsibility Principle (SRP):</b> Each adapter has one reason to change:
 *       the external system it adapts
 *   <li><b>Open/Closed Principle (OCP):</b> Adapters are open for extension (via inheritance)
 *       but closed for modification
 *   <li><b>Interface Segregation Principle (ISP):</b> Small, focused interfaces
 *       (Client, Repository, Messenger)
 *   <li><b>Don't Repeat Yourself (DRY):</b> Common adapter logic centralized in base classes
 * </ul>
 *
 ...
 * }</pre>
 *
 * <h3>Integration Testing Adapters</h3>
 * <pre>{@code
 * @Test
 ...
 *   <li><b>Log at Boundaries:</b> Log requests/responses at adapter boundaries for debugging.
