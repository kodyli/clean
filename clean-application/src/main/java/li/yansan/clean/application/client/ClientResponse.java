 ...
 *
 * <p>
 * This record encapsulates the result of an external API call, ensuring that
 * the returned
 ...
 *
 * <ul>
 * <li><b>Encapsulation:</b> Holds the {@code body} of the response returned by
 * the
 * client.
 * <li><b>Validation:</b> Enforces that the {@code body} is not null and
 * satisfies any
 * constraints defined on it (e.g., via Bean Validation annotations) upon
 * instantiation.
 * <li><b>Transformation:</b> Provides constructors to facilitate the conversion
 * of
