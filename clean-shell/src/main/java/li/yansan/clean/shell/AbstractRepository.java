 ...
 *
 * <p>This class acts as a bridge between the core business logic and the persistence layer.
 *
 * <p><b>Responsibilities:</b>
 *
 * <ul>
 *   <li><b>Take Input:</b> Accepts a standardized {@link RepositoryRequest} containing the data to
 *       be persisted or queried.
 *   <li><b>Map Input:</b> Converts the domain input ({@code UPayload}) into the database-specific
 *       format ({@code TI}).
 *   <li><b>Validate Input:</b> Validates the converted input ({@code TI}) to ensure it meets data
 *       format requirements (e.g., field length, nullability). <b>Note:</b> This is NOT business
 *       validation.
 *   <li><b>Send Input:</b> Sends the converted input to the database via the {@link
 *       #process(Object)} method.
 *   <li><b>Map Output:</b> Converts the database output ({@code TO}) back into the usecase domain
 *       format ({@code UBody}).
 ...
 */
public abstract class AbstractRepository<TI, TO, UPayload, UBody>
